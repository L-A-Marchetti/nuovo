...
app::app(std::string title, int w, int h) : title(title), w(w), h(h), r(nullptr)
{
	...
	int chans = 0;
	this->modules.push_back(new module("BASS DRUM", {{"TUNE", 32}, {"LEVEL", 64}, {"ATTACK", 45}, {"DECAY", 100}}, "samples/bd/", ++chans));
	this->modules.push_back(new module("SNARE DRUM", {{"TUNE", 20}, {"LEVEL", 73}, {"TONE", 50}, {"SNAPPY", 75}}, "samples/sd/", ++chans));
	this->modules.push_back(new module("LOW TOM", {{"TUNE", 40}, {"LEVEL", 127}, {"DECAY", 60}}, "samples/lt/", ++chans));
	this->modules.push_back(new module("MID TOM", {{"TUNE", 35}, {"LEVEL", 127}, {"DECAY", 70}}, "samples/mt/", ++chans));
	this->modules.push_back(new module("HIGH TOM", {{"TUNE", 45}, {"LEVEL", 109}, {"DECAY", 55}}, "samples/ht/", ++chans));
	this->modules.push_back(new module("RIM SHOT", {{"LEVEL", 47}}, "samples/rs/", ++chans));
	this->modules.push_back(new module("HAND CLAP", {{"LEVEL", 77}}, "samples/clp/", ++chans));
	this->modules.push_back(new module("CLOSED HAT", {{"LEVEL", 27}, {"DECAY", 65}}, "samples/hhc/", ++chans));
	this->modules.push_back(new module("OPEN HAT", {{"LEVEL", 51}, {"DECAY", 70}}, "samples/hho/", chans));
	this->modules.push_back(new module("CRASH", {{"LEVEL", 47}, {"DECAY", 80}, {"TUNE", 50}}, "samples/crh/", ++chans));
	this->modules.push_back(new module("RIDE", {{"LEVEL", 25}, {"DECAY", 80}, {"TUNE", 50}}, "samples/rd/", ++chans));
